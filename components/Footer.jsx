...
const Footer = () => {
  ...
  const horsePositionY = horsePositionX < -8 && horsePositionX > -165 ? -17 : 0;

  return (
    <footer className='relative h-24 border-t-2 w-screen bg-yellow-100 flex items-center justify-center'>
      <p>
        Powered by{" "}
        <a
